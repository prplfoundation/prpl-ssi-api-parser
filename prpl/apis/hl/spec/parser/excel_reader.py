...
class ExcelReader:
    ...
    It reads every sheet, namely 'Change-Log', 'Objects', 'Fields', 'Events',
    'Response Codes' and 'ToC', ands returns its contents as a list
    of dictionaries, which can then be converted to Python objects
    ...
    def _parse_sheet(self, name):
        """Parses de specified Excel sheet and returns its contents
        ...
        Returns:
            list<dict>: Array of dictionaries with cell contents. The keys are
            the header names.
        ...
        work_book = load_workbook(
            self.spec_path, data_only=True, read_only=True)
            ...
            # if we have the headers, let's parse the rest of the objects
                ...
                for r in range(len(row)):
                    ...
                    if row[0].value:
                        ...
                        # assign value to attribute on entry
                        # object named after header
    ...
    def get_change_log(self):
        """Parses the 'Change-Log' Excel sheet and returns a list of HL-API
        ...
        while True:
            ...
            # Parse header.
            tokens = header.split(' ')
            api_version = {'Number': tokens[1],
                           'Date': tokens[2][1:-1], 'Changes': []}
            ...
            while True:
                ...
                if change_number is None:
                    self.logger.debug('ChangeLog - Found version "{}" \
                        ({}) with {} changes.'.format(
                            api_version['Number'],
                            api_version['Date'],
                ...
                api_version['Changes'].append(
                    (change_number, change_description))
            ...
            self.logger.debug(
                'ChangeLog - Parsed entry {}.'.format(api_version))
    ...
    def get_procedures(self):
        """Parses the 'Objects & Methods' Excel sheet and returns a list
        of HL-API objects and procedures.
    ...
    def get_response_codes(self):
        """Parses the 'Response Codes' Excel sheet and returns as
        list of HL-API return codes.
    ...
    def _build_objects(self):
        ...
        It converts and links raw-data read from Excel file
        into HL-API objects.
    ...
    def parse(self):
        ...
        logger.info(
            'ChangeLog - Parsing finished with {} versions discovered.\n'
        ...
        logger.info(
            'Objects - Parsing finished with {} procedures discovered.\n'
        ...
        logger.info(
            'Parameters - Parsing finished with {} fields discovered.\n'
        ...
        logger.info(
            'Data Types - Parsing finished with {} fields discovered.\n'
        ...
        logger.info(
            'Response Codes - Parsing finished with {} response codes.\n'
        ...
        logger.info(
            'Events - Parsing finished with {} events.\n'
        ...
        logger.info(
            'ToC - Parsing finished with {} instances.\n'
