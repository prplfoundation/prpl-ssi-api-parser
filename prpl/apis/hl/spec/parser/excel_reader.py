...
class ExcelReader:
    ...
    def _parse_sheet(self, name):
        ...
        # Open work book.
        work_book = load_workbook(self.spec_path, data_only=True, read_only=False)
        ...
        # Read body, iterate trough each row.
        for row in sheet.iter_rows(min_row=2):
            ...
            for cell in row:
                ...
                # Merge values with headers and append entry.
